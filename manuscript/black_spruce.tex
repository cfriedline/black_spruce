...
then exported to a text file for further analysis. Finally, for those
unigenes without GO annotations directly from Blast2GO, GO terms were
added post-hoc using the mappings from InterPro-GO associations.
